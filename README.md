...
Then the app should display the latest BTC/USD exchange price from remote
...
Then the app should display an error message with the last updated value and date.
